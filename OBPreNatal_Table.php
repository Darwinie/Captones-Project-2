...
$sql = "SELECT * FROM patient_information WHERE record_type = 'Prenatal' ORDER BY id DESC";
  ...
  //////////////////////////////////////////////////////////////////////////////// -->
    ...
    <div class="table-wrapper">
        <div class="table-title">
          ...
          <table class="table table-striped mt-3" id="prenatalTable" style="width:100%">
            <thead>
          <tr>
            <th>#</th>
            <th>Family Number</th>
          ...
          <tbody>
            <?php do{ ?>
                <tr>
                        ...
                        <td>
                            <div class="col-2">
                            <a href="view_prenatal.php?id=<?php echo $row['id']; ?>" class="btn btn-primary mb-2">view</a>
                            </div>
