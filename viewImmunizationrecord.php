                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 text-end">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ImmunizationDetails">
                             Edit
                            </button>
                        </div>
                    </div>
                    ...
                    <?php 
                        ...
                        $sql = "SELECT * FROM tbl_adultimmunization_itr WHERE family_number LIKE $familynumber ORDER BY id DESC";
                      ...
                      <tr>
                        ...
                        <?php do{ ?>
                            <tr>
                                    ...
                                    <td><?php echo $row['medical_treatment']; ?></td>
                                    <td><?php echo $row['added_at']; ?></td>
                                    <td>
                                        <div class="col-2">
                                    
                                        <a href="view_immunization_itr.php?id=<?php echo $row['id']; ?>" class="btn btn-primary mb-2">view</a>  
                                    </td> 
                              </tr>
