...
// eto functions nito search nya yung variable na access sa array na access.
// inistore ko yung session access sa login page.
if (stripos(json_encode($access), $_SESSION['access']) == false) {
  $_SESSION['message'] = "You do not have access to patient page. Please contact Administrator.";
...
$sql = "SELECT * FROM patient_information WHERE record_type = 'General' ORDER BY id DESC";
