...
if (stripos(json_encode($access), $_SESSION['access']) == false) {
  $_SESSION['message'] = "You do not have access to TB Dots page. Please contact Administrator.";
...
$sql = "SELECT * FROM patient_information WHERE record_type = 'TB DOTS' ORDER BY id DESC";
    ...
    <div class="card mt-2">
      <div class="card-body">
        <div class="card-title">
          <div class="row">
            <div class="table">
              <div class="table-title">
                <div class="row">
                  <div class="col-sm-6">
                 <h2>List of <b>TB-DOTS</b></h2>
                 <?php include('Modals/tbDOTSModal.php'); ?>   
              </div>
              <!-- <div class="col-sm-6">
          ...
          <table class="table table-striped mt-3" id="tbDotsTable" style="width:100%">
            <thead>
          <tr>
            <th>#</th>
            <th>Family Number</th>
            ...
            <?php do{ ?>
                <tr>
                        ...
                        <td>
                            <div class="col-2">
                            <a href="viewTBrecords.php?id=<?php echo $row['id']; ?>" class="btn btn-primary mb-2">view</a>
                            </div>
