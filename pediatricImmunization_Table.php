...
if (stripos(json_encode($access), $_SESSION['access']) == false) {
  $_SESSION['message'] = "You do not have access to pedia immunization page. Please contact Administrator.";
  ...
  <div class="container mt-5">
    <div class="card mt-2">
      <div class="card-body">
          ...
          <div class="row">
            <div class="table">
              <div class="table-title">
                <div class="row">
                  <div class="col-sm-6">
                 <h2>List of Pediatric <b>Immunization</b></h2>
                 <?php include('Modals/vaccinationModal.php'); ?>   
              </div>
              <!-- <div class="col-sm-6">
        ...
        <table class="table table-striped mt-3" id="pediaImmuniTable" style="width:100%">
            <thead>
          <tr>
            <th>#</th>
            <th>Family Number</th>
            ...
            <?php do{ ?>
                <tr>
                        ...
                        <td>
                            <div class="col-2">
                            <a href="viewpediaImmunization.php?id=<?php echo $row['id']; ?>" class="btn btn-primary mb-2">view</a>
                            </div>
