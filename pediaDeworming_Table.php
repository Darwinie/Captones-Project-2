...
if (stripos(json_encode($access), $_SESSION['access']) == false) {
  $_SESSION['message'] = "You do not have access to pedia deworming page. Please contact Administrator.";
          ...
          <tr>
            ...
            <?php do{ ?>
                <tr>
                        ...
                        <td>
                            <div class="col-2">
                            <a href="viewdeworming.php?id=<?php echo $row['id']; ?>" class="btn btn-primary mb-2">view</a>
                            </div>
