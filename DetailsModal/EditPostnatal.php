...
<body>
  ...
  <div class="modal fade" id="postnatalDetails" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="postnatalDetailsLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="postnatalDetailsLabel">PATIENT RECORD</h5>
        ...
        <div class="modal-body">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3 mt-4" action="updatePostnatal.php" method="post">
                    <div class="row">
                      <div class="col-md-3">  
