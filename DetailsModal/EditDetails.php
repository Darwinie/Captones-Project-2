...
<body>
  ...
  <div class="modal fade" id="MedicalRecordDetails" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="patientRecordLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3 mt-4" action="updatepatientinformation.php" method="post">
                    <div class="row">
                      <div class="col-md-3">  
