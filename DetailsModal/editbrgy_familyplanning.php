...
<body>
  ...
  <div class="modal fade" id="brgyfplanningdetails" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="brgyfplanningdetailsLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="brgyfplanningdetailsLabel">PATIENT RECORD</h5>
        ...
        <div class="modal-body">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3 mt-4" action="update_familyplanning.php" method="post">
                    <div class="row">
                      <div class="col-md-3">  
                        ...
                        <div class="col-md-2">
                            <label for="inputFamilyCode" class="form-label fw-bold">Barangay</label>
                            <input type="text" class="form-control" value="<?php echo $row['barangay']; ?>" name="barangay" id="barangay">
                        </div>
                    </div>
