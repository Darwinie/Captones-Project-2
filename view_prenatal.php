...
?>
  ...
  //////////////////////////////////////////////////////////////////////////////// -->
        ...
        <?php include('DetailsModal/EditPrenatal.php'); ?>  
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 text-end">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#prenatalDetails">
                             Edit
                            </button>
                        </div>
                    </div>
                    ...
                    <?php 
                        ...
                        $sql = "SELECT * FROM tbl_prenatal_itr WHERE family_number LIKE $familynumber ORDER BY id DESC";
                        ...
                        <?php do{ ?>
                            <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="view_prenatal_itr.php?id=<?php echo $row['id']; ?>" class="btn btn-primary mb-2">view</a>
