...
?>
<?php include('DetailsModal/editbrgy_deworming.php'); ?>  
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" name="barangay" value="<?php echo $row['barangay']; ?>" id="barangay">
                        </div>
                        <div class="col-sm">
                            
                        </div>
                        <div class="col-md-2 text-end">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#brgydewormingdetails">
                             Edit
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" name="bloodtype" value="<?php echo $row['blood_type']; ?>" id="inputBloodType">
                        </div>
                        <div class="col-2">
                    ...
                    <?php 
                        ...
                        $sql = "SELECT * FROM tbl_pediadeworming_itr WHERE family_number LIKE $familynumber ORDER BY id DESC";
                        $pediadeworm_itr = $con->query($sql) or die ($con->error);
                        $row = $pediadeworm_itr->fetch_assoc();
                    ...
                    <div class="table-title">
                      <div class="row">
                          <div class="col-sm-6">
                             ...
                             <h3>Deworming History <b> History</b></h3>
                          </div>
                          <div class="col-sm-6">
                    ...
                    <table class="table">
                      ...
                      <tr>
                        ...
                        <th>Date of Last Deworming</th>
                        <th>attending_provider</th>
                        <th>temperature</th>
                        <th>Time Added</th>
                        <th>Action</th>
                      </tr>
                        ...
                        <?php do{ ?>
                            <tr>
                                    ...
                                    <td><?php echo $row['date_deworming'];?></td>
                                    <td><?php echo $row['date_lastdeworming']; ?></td>
                                    <td><?php echo $row['attending_provider']; ?></td>
                                    <td><?php echo $row['temperature']; ?></td>
                                    <td><?php echo $row['added_at']; ?></td>
                                    <td>
                                        <div class="col-2">
                                    
                                        <a href="viewdeworming_itr.php?id=<?php echo $row['id']; ?>" class="btn btn-primary mb-2">view</a>
                                        
                                    </td> 
                              </tr>
                        <?php }while($row = $pediadeworm_itr->fetch_assoc()); ?>
                        </tbody>
                    </table>
                  </div>
                  </div>
