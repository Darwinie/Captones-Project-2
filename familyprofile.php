...
<head>
    ...
    <title>Create Family Profiling</title>
    <!-- Bootstrap CDN MODAL -->
                    ...
                    <div class="row">
                      <div class="col-md-3">  
                        ...
                        <div class="col-sm-2" style="width: 10rem; margin-left: -15px;">
                            ...
                            <input type="number" class="form-control " name="novaccinated1[]" id="inputnovaccinated">
                        </div>
                        <div class="col-sm-2" style="width: 10rem; margin-left: -15px;">
                      ...
                      <h4 class="ITRtitle justify-content-center text-center">II. Health and Condition and Problem Sheet</h4>
                        ...
                        <div class="col-sm-2 mt-4" style="width: 12rem;">
