                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 text-end">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#TBRecordDetails">
                             Edit
                            </button>
                        </div>
                    </div>
                    ...
                    <?php 
                        ...
                        $sql = "SELECT * FROM tbl_tbdots_itr WHERE family_number LIKE $familynumber ORDER BY id DESC";
