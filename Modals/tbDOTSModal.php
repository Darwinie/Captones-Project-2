...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tbDOTS">
  TB DOTS
</button>


     <!-- FOR TB DOTS -->
  <div class="modal fade" id="tbDOTS" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="tbDOTSLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="tbDOTSLabel">TB DOTS PATIENT RECORD</h5>
