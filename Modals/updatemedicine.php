...
<body>
    ...
    <!-- Medicine Form-->
    <div class="modal fade" id="updatemedicineinventory" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="updatemedicineinventory
    Label" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="updatemedicineinventoryLabel">Medicine Inventory</h5>
