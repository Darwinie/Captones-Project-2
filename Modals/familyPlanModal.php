...
<body>
  ...
  <!-- FOR FAMILY PLANNING MODAL -->
  <div class="modal fade" id="familyplanning" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="familyplanningLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="familyplanningLabel">PATIENT RECORD</h5>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-u1OknCvxWvY5kfmNBILK2hRnQC3Pr17a+RTT6rIHI7NnikvbZlHgTPOOmMi466C8" crossorigin="anonymous"></script>
                        ...
                        <!-- <div class="col-3">
                            <label for="inputTypeClient" class="form-label">Type of Client</label>
                            <input type="text" name="typeofclient" class="form-control" id="inputTypeClient">
                        </div>
                        <div class="col-3">
                            <label for="inputReason" class="form-label">If Drop-Out, state Reason</label>
                            <input type="text" name="dropreason" class="form-control" id="inputReason">
                        </div>
                        <div class="col-3">
                            <label for="inputSchedNextVisit" class="form-label">Schedule of Next Visit</label>
                            <input type="text" name="nextvisit" class="form-control" id="inputSchedNextVisit">
                        </div>   -->