...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Deworming">
  Deworming
   ...
   <!-- FOR DEWORMING -->
   <div class="modal fade" id="Deworming" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="DewormingLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="DewormingLabel">Deworming</h5>
                      ...
                      <form class="row g-3 mt-4" action="insertpatientinformation.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                              ...
                              <input type="text" name="datelastdeworming" class="form-control" id="inputTemperature">
                            </div>
                            <div class="col-3">
