...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#preNatal">
  PRENATAL
</button>


  <!-- FOR OB PRENATAL -->
  <div class="modal fade" id="preNatal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="preNatalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="preNatalLabel">PATIENT RECORD</h5>
                  ...
                  <div class="row">
                      ...
                      <h5 class="ITRtitle justify-content-center text-center shadow">INDIVIDUAL TREATMENT RECORD</h5>
                        ...
                        <div class="col-3">
                          ...
                          <input type="text" name="estimatedduedate" class="form-control" id="inputEDC">
                        </div>
                        <div class="col-3">
                        ...
                        <div class="col-3">
                          ...
                          <input type="text" name="schednextvisit" class="form-control" id="inputSchedNextVisit" placeholder="dd/mm/yyyy">
                        </div>
                        <div class="col-3">
