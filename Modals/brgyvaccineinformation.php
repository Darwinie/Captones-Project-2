...
<body>
  ...
  <!-- FOR VACCINE RECORD GENERAL -->
  <div class="modal fade" id="brgyvaccinerecord" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="brgyvaccinerecordLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="brgyvaccinerecordLabel">PATIENT RECORD</h5>
        ...
        <div class="modal-body">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3 mt-4" action="insertbrgy_patientinformation.php" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select id="inputFormtype" name="formtype" class="form-select">
                              <option selected>Pediatric Immunization</option>
                            </select>
                        </div>
                        </div>
