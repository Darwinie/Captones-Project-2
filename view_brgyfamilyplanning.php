...
?>
<?php include('DetailsModal/editbrgy_familyplanning.php'); ?>  
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" name="barangay" value="<?php echo $row['barangay']; ?>" id="familycode">
                        </div>
                        <div class="col-sm-2">
                            
                        </div>
                        <div class="col-md-2 text-end">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#brgyfplanningdetails">
                             Edit
                            </button>
                        </div>
                    </div>
                    ...
                    <?php 
                        ...
                        $sql = "SELECT * FROM tbl_familyplanning_itr WHERE family_number LIKE $familynumber ORDER BY id DESC";
                    ...
                    <div class="table-title">
                      <div class="row">
                          <div class="col-sm-6">
                             ...
                             <h3>Family Planning <b> History</b></h3>
                          </div>
                          <div class="col-sm-6">
                      ...
                      <tr>
                        ...
                        <?php do{ ?>
                            <tr>
                                    ...
                                    <td><?php echo $row['type_of_client'];?></td>
                                    <td><?php echo $row['method']; ?></td>
                                    <td><?php echo $row['sched_nextvisit']; ?></td>
                                    <td><?php echo $row['attending_provider']; ?></td>
                                    <td><?php echo $row['added_at']; ?></td>
                                    <td>
                                        <div class="col-2">
                                    
                                        <a href="view_fplanning_itr.php?id=<?php echo $row['id']; ?>" class="btn btn-primary mb-2">view</a>
                                        
                                    </td> 
                              </tr>
                        <?php }while($row = $tb_itr->fetch_assoc()); ?>
                        </tbody>
                    </table>
                  </div>
                  </div>
