...
$query = $con->query($sql) or die ($con->error);
 ...
 if($query==1)
 {
      ...
      `referred_by`, `consultation_date`, `consulation_time`, `attending_provider`, `nature_visit`, `bloodpressure`, `temperature`,
       `respiratory_rate`, `pulse_rate`, `height`, `weight`, `chief_complaints`, `diagnosisis`, `medication_treatment`, 
       `healhcare_provider`, `laboratory_findings`, `performedlaboratory_test` ) VALUES ('$fserial','$transacmode','$reffrom','$refto','$refreason','$refby','$consuldate','$consultime','$attprovider','$natvisit',
