                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 text-end">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#postnatalDetails">
                             Edit
                            </button>
                        </div>
                    </div>
                    ...
                    <?php 
                        ...
                        $sql = "SELECT * FROM tbl_postnatal_itr WHERE family_number LIKE $familynumber ORDER BY id DESC";
                        ...
                        <?php do{ ?>
                            <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="view_postnatal_itr.php?id=<?php echo $row['id']; ?>" class="btn btn-primary mb-2">view</a>
