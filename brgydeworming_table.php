...
<head>
    ...
    <title>Barangay Health Office</title>
...
$sql = "SELECT * FROM patient_information WHERE record_type = 'Deworming' ORDER BY id DESC";
$brgydeworming = $con->query($sql) or die ($con->error);
$row = $brgydeworming->fetch_assoc();
              ...
              <div class="card-title">
                ...
                <div class="table">
                  <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                           <h2>List of Pediatric <b>Deworming</b></h2>
                  ...
                  <table class="table table-striped mt-3" id="pediaDewormTable" style="width:100%">
                      <thead>
                    <tr>
                      <th>#</th>
                      <th>Family Number</th>
                      ...
                      <?php do{ ?>
                          <tr>
                                  ...
                                  <td>
                                      <div class="col-2">
                                      <a href="viewbrgy_deworming.php?id=<?php echo $row['id']; ?>" class="btn btn-primary mb-2">view</a>
                                      </div>
                                      
                                       
                                  </td> 
                            </tr>
                            <?php }while($row = $brgydeworming->fetch_assoc()); ?>
                          </tbody>
                      </table>
                    </div>
                    </div>
